...
class AboutMessagePassing < Neo::Koan
  ...
  def test_all_messages_are_caught
    ...
    assert_equal text + 'foobar with <>', catcher.foobar
    assert_equal text + 'foobaz with <1>', catcher.foobaz(1)
    assert_equal text + 'sum with <1, 2, 3, 4, 5, 6>', catcher.sum(1,2,3,4,5,6)
  end
